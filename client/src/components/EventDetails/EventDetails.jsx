    ...
    return (
      ...
      <div className={classes.card}>
        <div className={classes.section}>
          ...
          <Typography gutterBottom variant="body1" component="p">{event.event_desc}</Typography>
          
          
         
        </div>
        <div className={classes.imageSection}>
          <img className={classes.media} src={ event.photo || 'https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png'} alt={event.title} />
        </div>
      </div>
